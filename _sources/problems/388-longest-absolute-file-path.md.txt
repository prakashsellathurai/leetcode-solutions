...
Try it on <a href='https://leetcode.com/problems/388-longest-absolute-file-path'>leetcode</a>
...
class Solution:
    def lengthLongestPath(self, input: str) -> int:
        return self.withdictionary(input)

    def withdictionary(self, input: str) -> int:
        pathLen = {-1: 0}
        maxlen = 0
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "class Solution:\n    def lengthLongestPath(self, input: str) -> int:\n        return self.withdictionary(input)\n\n    def withdictionary(self, input: str) -> int:\n        pathLen = {-1: 0}\n        maxlen = 0\n\n        for line in input.split(\"\\n\"):\n            depth = line.count(\"\\t\")\n            name = line.lstrip(\"\\t\")\n\n            if \".\" in line:\n                maxlen = max(maxlen, pathLen[depth - 1] + len(name))\n            else:\n                pathLen[depth] = pathLen[depth - 1] + len(name) + 1\n        return maxlen\n",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/388-longest-absolute-file-path/",
      "datePublished": "2022-06-19T23:02:59+05:30",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
