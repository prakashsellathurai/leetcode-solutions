...
Try it on <a href='https://leetcode.com/problems/665-non-decreasing-array'>leetcode</a>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "text": "Given an array nums with n integers, your task is to check if it could become non-decreasing by modifying at most one element.\nWe define an array is non-decreasing if nums[i] <= nums[i + 1] holds for every i (0-based) such that (0 <= i <= n - 2).\n\u00a0\nExample 1:\nInput: nums = [4,2,3]\nOutput: true\nExplanation: You could modify the first 4 to 1 to get a non-decreasing array.\n\nExample 2:\nInput: nums = [4,2,1]\nOutput: false\nExplanation: You can't get a non-decreasing array by modify at most one element.\n\n\u00a0\nConstraints:\n\nn == nums.length\n1 <= n <= 104\n-105 <= nums[i] <= 105\n\n",
    "url": "https://leetcode.com/problems/665-non-decreasing-array",
    "answerCount": 1,
    "datePublished": "2022-06-25T12:29:03+05:30",
    "author": {
      "@type": "Organization",
      "name": "LeetCode",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "class Solution:\n    def checkPossibility(self, N: List[int]) -> bool:\n        err = 0\n        for i in range(1, len(N)):\n            if N[i] < N[i-1]:\n                if err or (i > 1 and i < len(N) - 1 and N[i-2] > N[i] and N[i+1] < N[i-1]):\n                    return False\n                err = 1\n        return True",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/665-non-decreasing-array/",
      "datePublished": "2022-06-25T12:29:03+05:30",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
