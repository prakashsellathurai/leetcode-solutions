...
Try it on <a href='https://leetcode.com/problems/124-binary-tree-maximum-path-sum'>leetcode</a>
...
class Solution:
    def maxPathSum(self, root: Optional[TreeNode]) -> int:
        ...
        def dfs(node):
            ...
            cur_gain = node.val + max(left, right)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/124-binary-tree-maximum-path-sum",
    "answerCount": 1,
    "datePublished": "2022-07-07T11:01:56+05:30",
    "author": {
      "@type": "Organization",
      "name": "LeetCode",
    ...
    "acceptedAnswer": {
      ...
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/124-binary-tree-maximum-path-sum/",
      "datePublished": "2022-07-07T11:01:56+05:30",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
