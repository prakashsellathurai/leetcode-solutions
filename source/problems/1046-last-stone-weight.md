...
Try it on <a href='https://leetcode.com/problems/1046-last-stone-weight'>leetcode</a>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/1046-last-stone-weight",
    "answerCount": 1,
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "class Solution:\n    # Time Complexity: O(nlogn)\n    # Space Complexity: O(n)\n    def lastStoneWeight(self, stones: List[int]) -> int:\n        heap = [-stone for stone in stones]\n        heapq.heapify(heap)\n\n        while len(heap) > 1:\n            diff = heapq.heappop(heap) - heapq.heappop(heap)\n\n            if diff != 0:\n                heapq.heappush(heap, diff)\n\n        return -heap[0] if len(heap) == 1 else 0\n",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/1046-last-stone-weight/",
      "datePublished": "2022-06-19T23:02:59+05:30",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
