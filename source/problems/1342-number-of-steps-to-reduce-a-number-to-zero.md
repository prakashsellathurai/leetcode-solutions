...
Try it on <a href='https://leetcode.com/problems/1342-number-of-steps-to-reduce-a-number-to-zero'>leetcode</a>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/1342-number-of-steps-to-reduce-a-number-to-zero",
    "answerCount": 1,
    "author": {
      "@type": "Organization",
      "name": "LeetCode",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "class Solution:\n    def numberOfSteps(self, num: int) -> int:\n        cnt = 0\n        while num:\n            if num & 1:\n                num -= 1\n            else:\n                num //= 2\n            cnt += 1\n        return cnt\n",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/1342-number-of-steps-to-reduce-a-number-to-zero/",
