...
Try it on <a href='https://leetcode.com/problems/160-intersection-of-two-linked-lists'>leetcode</a>
...
class Solution:
    def getIntersectionNode(
        ...
        Alth = self.getlength(headA)
        Blth = self.getlength(headB)
        diff = abs(Alth - Blth)
        if Blth > Alth:
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/160-intersection-of-two-linked-lists",
    "answerCount": 1,
    ...
    "acceptedAnswer": {
      ...
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/160-intersection-of-two-linked-lists/",
      "datePublished": "2023-04-25T00:00:00Z",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
