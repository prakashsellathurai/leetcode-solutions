...
Try it on <a href='https://leetcode.com/problems/1396-design-underground-system'>leetcode</a>
...
class UndergroundSystem:
    ...
    def checkOut(self, id: int, stationName: str, t: int) -> None:
        checkIn = self.checkInMap[id]
        self.checkInMap.pop(
            id
        )  # Remove after using it which will not make HashTable big
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "acceptedAnswer": {
      ...
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/1396-design-underground-system/",
