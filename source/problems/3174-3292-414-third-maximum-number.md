...
Try it on <a href='https://leetcode.com/problems/3174-3292-414-third-maximum-number'>leetcode</a>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/3174-3292-414-third-maximum-number",
    "answerCount": 1,
    "datePublished": "2025-02-05T23:15:57+05:30",
    "author": {
      "@type": "Organization",
      "name": "LeetCode",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "class Solution:\n    def thirdMax(self, nums: List[int]) -> int:\n        # Sort the array.\n        nums.sort(reverse=True)\n\n        elem_counted = 1\n        prev_elem = nums[0]\n\n        for index in range(len(nums)):\n            # Current element is different from previous.\n            if nums[index] != prev_elem:\n                elem_counted += 1\n                prev_elem = nums[index]\n\n            # If we have counted 3 numbers then return current number.\n            if elem_counted == 3:\n                return nums[index]\n\n        # We never counted 3 distinct numbers, return largest number.\n        return nums[0]\n",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/3174-3292-414-third-maximum-number/",
      "datePublished": "2025-02-05T23:15:57+05:30",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
