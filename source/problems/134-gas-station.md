...
Try it on <a href='https://leetcode.com/problems/134-gas-station'>leetcode</a>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/134-gas-station",
    "answerCount": 1,
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "class Solution:\n    def canCompleteCircuit(self, gas: List[int], cost: List[int]) -> int:\n        n = len(gas)\n        total_gas = 0\n        start = 0\n        cur_tank = 0\n        for i in range(n):\n            cur_tank += gas[i] - cost[i]\n            total_gas += gas[i] - cost[i]\n\n            if cur_tank < 0:\n                start = i + 1\n                cur_tank = 0\n\n        return start if total_gas >= 0 else -1\n",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/134-gas-station/",
      "datePublished": "2026-03-19T00:00:00Z",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
