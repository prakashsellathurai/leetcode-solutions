...
Try it on <a href='https://leetcode.com/problems/8-string-to-integer-atoi'>leetcode</a>
...
INT_MAX_DIV = INT_MAX // 10
INT_MAX_MOD = INT_MAX % 10
...
class Solution:
    def myAtoi(self, s: str) -> int:
        ...
        while i < n and s[i].isdigit():
            ...
            if res > INT_MAX_DIV or res == INT_MAX_DIV and d > INT_MAX_MOD:
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/8-string-to-integer-atoi",
    "answerCount": 1,
    "author": {
      "@type": "Organization",
      "name": "LeetCode",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "INT_MAX = pow(2, 31) - 1\nINT_MIN = -pow(2, 31)\n\nINT_MAX_DIV = INT_MAX // 10\nINT_MAX_MOD = INT_MAX % 10\n\n\nclass Solution:\n    def myAtoi(self, s: str) -> int:\n        sign = 1\n        res = 0\n\n        i = 0\n        n = len(s)\n\n        # skip whitespace\n        while i < n and s[i] == \" \":\n            i += 1\n\n        if i < n and s[i] == \"+\":\n            sign = 1\n            i += 1\n        elif i < n and s[i] == \"-\":\n            sign = -1\n            i += 1\n\n        while i < n and s[i].isdigit():\n            d = int(s[i])\n\n            if res > INT_MAX_DIV or res == INT_MAX_DIV and d > INT_MAX_MOD:\n                return INT_MAX if sign == 1 else INT_MIN\n            res = 10 * res + d\n            i += 1\n\n        return sign * res\n",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/8-string-to-integer-atoi/",
