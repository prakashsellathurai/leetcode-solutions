...
Try it on <a href='https://leetcode.com/problems/785-is-graph-bipartite'>leetcode</a>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": {
    ...
    "url": "https://leetcode.com/problems/785-is-graph-bipartite",
    "answerCount": 1,
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "class Solution:\n    def isBipartite(self, graph: List[List[int]]) -> bool:\n        return self.dfs(graph)\n\n    # Time Complexity: O(V+E)\n    # Space Complexity: O(V+E)\n    def bfs(self, graph: List[List[int]]) -> bool:\n        n = len(graph)\n        color = [-1] * n\n        q = []\n\n        for i in range(n):\n            if color[i] == -1:\n                q.append((i, 0))\n                color[i] = 0\n\n                while q:\n                    u, c = q.pop()\n\n                    for v in graph[u]:\n                        if color[v] == c:\n                            return False\n\n                        if color[v] == -1:\n                            color[v] = 1 - c\n                            q.append((v, color[v]))\n        return True\n\n    # Time Complexity: O(V+E)\n    # Space Complexity: O(V+E)\n    def dfs(self, graph: List[List[int]]) -> bool:\n        n = len(graph)\n        color = {}\n\n        def recur(u, c):\n            for v in graph[u]:\n                if v not in color:\n                    color[v] = 1 - c\n                    if not recur(v, color[v]):\n                        return False\n                if color[v] == c:\n                    return False\n\n            return True\n\n        for u in range(n):\n            if u not in color:\n                color[u] = 0\n                if not recur(u, 0):\n                    return False\n        return True\n",
      "url": "https://prakashsellathurai.com/leetcode-solutions/problems/785-is-graph-bipartite/",
      "datePublished": "2024-10-20T00:00:00Z",
      "upvoteCount": 0,
      "author": {
        "@type": "Person",
